...
export class DocumentController {
    ...
    async uploadFile(@Request() req, @UploadedFile() file: Express.Multer.File) {
        const walletAddress = req.user.walletAddress;
        await this.storageService.upload(walletAddress, file.originalname, file.buffer);
    }
    ...
    async downloadFile(
        ...
        return this.storageService.download(walletAddress, parseInt(index, 10), downloaderWalletAddress);
    }
}
